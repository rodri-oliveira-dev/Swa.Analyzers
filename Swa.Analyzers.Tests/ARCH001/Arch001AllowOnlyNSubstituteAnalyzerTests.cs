...
public sealed class Arch001AllowOnlyNSubstituteAnalyzerTests
{
    ...
    [Fact]
    public async Task Reports_diagnostic_for_blocked_using_even_without_symbol_resolution()
    {
        var source = """
            using [|FakeItEasy|];
    ...
    [Fact]
    public async Task Does_not_report_for_prefix_that_only_starts_with_blocked_name()
    {
        var source = """
